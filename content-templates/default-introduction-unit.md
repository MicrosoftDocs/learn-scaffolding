<!-- 1. Topic sentence(s) --------------------------------------------------------------------------------
    ...
    Header: do not add an H1 or H2 title here, the auto-generated H1 will appear above this content automatically
...
<!-- 2. Scenario -----------------------------------------------------------------------------------------
    ...
    Header: use the H2 "Example scenario"
...
<!-- 3. Prose table-of-contents --------------------------------------------------------------------------
    ...
    Header: use the H2 "What will we be doing?"
...
<!-- 4. Terminal learning objective ----------------------------------------------------------------------
    ...
    Header: use the H2 "What is the main goal?"
